...
INSERT INTO "new_Ticket" ("contactoId", "descripcionDetallada", "empresaId", "equipoAfectado", "estado", "fechaCreacion", "fechaSolucionEstimada", "fechaSolucionReal", "id", "numeroCaso", "prioridad", "solicitanteCorreo", "solicitanteNombre", "solicitanteTelefono", "tecnicoAsignadoId", "tipoIncidente", "titulo", "updatedAt") SELECT "contactoId", "descripcionDetallada", "empresaId", "equipoAfectado", "estado", "fechaCreacion", "fechaSolucionEstimada", "fechaSolucionReal", "id", "numeroCaso", "prioridad", "solicitanteCorreo", "solicitanteNombre", "solicitanteTelefono", "tecnicoAsignadoId", "tipoIncidente", "titulo", "updatedAt" FROM "Ticket";
DROP TABLE "Ticket";
