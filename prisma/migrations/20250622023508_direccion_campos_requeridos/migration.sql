/*
  ...
  - Made the column `calle` on table `direcciones` required. This step will fail if there are existing NULL values in that column.
  - Made the column `numero` on table `direcciones` required. This step will fail if there are existing NULL values in that column.
