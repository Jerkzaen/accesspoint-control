...
import { createEmpresa, empresaSchema, EmpresaInput } from "@/app/actions/empresaActions";

interface CreateEmpresaFormProps {
  onSuccess?: () => void;
}

// CORRECCIÓN: Se asegura que la exportación sea una 'named export' estándar.
export function CreateEmpresaForm({ onSuccess }: CreateEmpresaFormProps) {
