// src/components/SingleTicketItemCard.tsx (ACTUALIZADO - Badge de Estado Interactiva)
'use client';
...
export default function SingleTicketItemCard({ ticket, onSelectTicket, isSelected }: SingleTicketItemCardProps) {
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      // Notificar al componente padre (TicketCard) para que actualice su estado
      onSelectTicket(updatedTicketData); // Esto actualizará el ticket seleccionado
      // Y TicketCard.tsx ya tiene onTicketUpdated que actualiza la lista
    } catch (err: any) {
