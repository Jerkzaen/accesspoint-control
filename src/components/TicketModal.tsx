...
interface TicketModalProps {
  ...
  onClose: () => void;
  nextNroCaso: number;
  onFormSubmitSuccess: (newTicket?: Ticket) => void; // <--- MODIFICADO: Ahora espera el ticket
...
// Exportación nombrada consistente
export function TicketModal({ // <--- EXPORTACIÓN NOMBRADA
  isOpen, 
  onClose, 
  nextNroCaso, 
  onFormSubmitSuccess,
    ...
    >
      ...
      >
        ...
        <TicketFormInModal
          ...
          onFormSubmitSuccess={onFormSubmitSuccess} // <--- MODIFICADO: Pasa el callback modificado
          onCancel={onClose}
