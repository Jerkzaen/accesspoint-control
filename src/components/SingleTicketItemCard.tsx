  ...
  return (
    <Card
      className={cn(
        ...
        "hover:shadow-xl", // Sombra más pronunciada en hover general
        {
          // Estilos para la tarjeta SELECCIONADA
          // Quitamos el ring y el border-primary. Confiamos en el fondo y la sombra.
          "shadow-lg bg-primary/15 dark:bg-primary/10": isSelected,
          // Estilos para tarjetas NO SELECCIONADAS
          // Aumentamos un poco la opacidad del hover para que sea más visible.
          "shadow-md dark:border-slate-700 hover:bg-primary/10 dark:hover:bg-primary/5": !isSelected,
        }
      )}
